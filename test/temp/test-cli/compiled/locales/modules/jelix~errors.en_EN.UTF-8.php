<?php $_loaded= array (
  ...
  'selector.invalid.syntax' => '(10)Invalid Syntax in the "%1$s" selector (type:%2$s)',
  'selector.invalid.target' => '(11)The selector "%s" doesn\'t correspond to a resource of type : "%s"',
  'selector.module.unknow' => '(12)Unknow module in the selector "%s"',
  ...
  'urls.engine.notfound' => '(30)Url engine "%s" is not found',
  'cli.unknow.command' => '(40)Unknow command "%s"',
  'cli.param.missing' => '(41)Missing parameter "%s"',
  'cli.option.value.missing' => '(42)value for option "%s" is missing',
  'cli.unknow.option' => '(43)Unknow option "%s"',
  ...
  'ad.controller.file.unknow' => '(100)Action %s : controller file %s doesn\'t exists',
  'ad.controller.class.unknow' => '(101)Action %s :  controller class %s doesn\'t exists (file : %s)',
  'ad.controller.method.unknow' => '(102)Action %s : method %s of the controller class %s doesn\'t exists (file : %s)',
  'ad.response.unknow' => '(110)Action %s : response %s doesn\'t exists (file : %s)',
  'ad.response.type.unknow' => '(111)Action %s : the response type "%s" is unknown (file : %s)',
  ...
  'action.unknow' => '(131)unknow action "%s"',
  'response.missing' => '(132)response is missing (action %s)',
  'default.response.type.unknow' => '(133)Action %s : unknow default type "%s"',
  ...
  'module.unknow' => '(136)Unknow module "%s"',
  ...
  'repbin.unknow.file' => '(152) unknow file for binary response (%s)',
  'repredirect.empty.url' => '(153) Impossible to do redirection : empty url',
  'reptcpdf.not_a_jtcpdf' => '(154) No jTcpdf object has been provided',
  'locale.key.selector.invalid' => '(200)The given locale key "%s" is invalid  ( charset %s, lang %s)',
  'locale.key.unknow' => '(201)The given locale key "%s" from module "%s" (and  charset %s, lang %s) does not exists',
  'locale.key.file.unknow' => '(202) The file of the given locale key "%s" from module "%s" (and  charset %s, lang %s) does not exists',
  ...
  'tpl.tag.function.unknow' => '(302)In the template %2$s, unknow fonction %1$s',
  'tpl.tag.modifier.invalid' => '(303)In the tag %s in the template %3$s, invalid syntax on the modifier %2$s',
  'tpl.tag.modifier.unknow' => '(304)In the tag %s  in the template %3$s,  unknow modifier %2$s',
  ...
  'tpl.tag.meta.unknow' => '(312)In the template %2$s, the meta tag %1$s is unknow',
  ...
  'tplplugin.function.argument.unknow' => '(322)In the tag %2$s in the template %3$s, the %1$s argument is unknown',
